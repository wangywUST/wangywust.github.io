...
|------|---------|-------|--------------|---------------------|
| 1 | Lecture 1 | Overview of LLMs | • What is language?<br>• Language models fundamentals<br>• Large language models introduction<br>• Historical evolution (SLM → NLM → PLM → LLM) | • Understand the definition and properties of language<br>• Learn probability distribution over token sequences<br>• Grasp the evolution from statistical to large language models<br>• Understand scaling laws and emergent abilities |
